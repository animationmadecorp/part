...
export default async function Page({searchParams}) {
 ...
 return <Library resources={editorial.resources} initialTab={p.onglet==="suivi"?"Mon suivi":p.onglet==="compte"?"Mon compte":p.onglet==="tableau-de-bord"?"Tableau de bord":"Ma bibliothèque"} initialFollowUp={requestedFollowUp} initialRequestId={requestedRequestId} initialEnglishLesson={requestedEnglishLesson}/>;
}
