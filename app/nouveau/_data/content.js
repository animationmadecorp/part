  ...
  home: [
    {
      ...
      emphasis: "Made.",
      items: [
        { stableId: "bio:career", body: "J’ai commencé ma carrière en tant qu’animatrice 3D sur différentes séries, puis je suis devenue lead animatrice sur le dernier long métrage de Michel Ocelot, puis sur la saison 6 de Tchoupi :) Je suis ensuite devenue prof d’animation, de gestion de production, et d’anglais." },
        { stableId: "bio:studios", body: "Aujourd’hui, je suis à mon compte et j’ai réussi à faire de l’animation une de mes activités principales, notamment en faisant du contenu sur les réseaux. Après avoir travaillé dans cinq studios différents dans différentes régions, je connais aussi bien le travail en studio que l’entrepreneuriat." },
        { stableId: "bio:mission", body: "À force d’observer tout ça, j’ai décidé de construire des méthodes pour faire des retours constructifs que vous pouvez conserver (je vous balance pas une heure de moi en Visio qui parle en regardant votre contenu). Sur cette plateforme vous trouverez tout ce que je trouve utile et qui permet d’accélerer dans ce milieu, qui convient à beaucoup d’objectifs différents." },
      ],
    },
    {
      ...
      sheetLabel: "EN PLUS DES PRESTATIONS",
      sheetTitle: "Add-ons Blender et conseils pratiques.",
      sheetBody: "Vous trouverez dans votre espace de connexion des ressources reliées à l’intermittence, des conseils d’animation, ainsi que des add-ons que j’ai conçus pour Blender.",
    },
    {
...
export const pages = [
  {
    ...
    hero: {
      eyebrow: "POUR LES ÉTUDIANTS ET ARTISTES EN CINÉMA D’ANIMATION",
      title: "Faire de ton talent",
      emphasisPrefix: "une vraie",
      emphasis: "trajectoire.",
      lead: "Des cours et une documentation faite sur-mesure pour progresser en animation, construire ton showreel, améliorer ton anglais spécifiquement dans ces disciplines ou faire connaître ton travail sur les réseaux.",
    },
    seo: {
      title: "Animation Made — faire de ton talent une vraie trajectoire",
      description:
